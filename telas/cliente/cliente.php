                    ...
                    <div class="col-sm-12" > 
                      <div class="row " >
                        <main class="form-signin">
                          <form action="../../controle/cadastro_cliente_script.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="datanasc" id="datanasc" class="form-control" id="floatingInput" placeholder="Data de Nascimento" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="endereco" id="endereco" class="form-control" id="floatingInput" placeholder="Endereço*">
