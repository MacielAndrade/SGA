            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class="container-fluid">
                    <div class="collapse navbar-collapse justify-content-right" id="navigation">
                        <button>
                            <a href="cliente.php" style="color: black;"><i class="fas fa-chevron-left fa-2x"></i></a>
                        </button>
                    </div>
                    <a class="navbar-brand" href=""> PESQUISAR CLIENTES </a>
                         ...
                         <?php
                            while ($linha = mysqli_fetch_assoc($dados)){
                                ...
                                echo "<tr>
                                  ...
                                  <td>$telefone</td>
                                  <td>$endereco</td>
                                  <td><a href='clienteAtualizar.php?id=$cod_cliente'><i class='far fa-edit fa-2x'></i></a></td>
                                  <td><a href='../../controle/excluir_cliente_script.php?id=$cod_cliente'><i  class='far fa-trash-alt fa-2x' style='color: red;'></i></a></td>
                                </tr>";    
                            }
                          ?>
                        </tbody>
