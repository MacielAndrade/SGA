            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class="container-fluid">
                    <div class="collapse navbar-collapse justify-content-right" id="navigation">
                        <button>
                            <a href="funcionario.php" style="color: black;"><i class="fas fa-chevron-left fa-2x"></i></a>
                        </button>
                    </div>
                    <a class="navbar-brand" href=""> PESQUISAR FUNCIONARIOS </a>
                ...
                <div class="container">
                  ...
                  <div class="row" >
                    <?php
                      ...
                      $sql="SELECT * FROM funcionario WHERE nome_funcionario LIKE '%$pesquisa%'";
                        ...
                        <tbody>
                         <?php
                            while ($linha = mysqli_fetch_assoc($dados)){
                                ...
                                $telefone = $linha['telefone_funcionario'];
                                $email = $linha['email_funcionario'];
                                $senha = $linha['senha_funcionario'];
                                echo "<tr>
                                  <td>$nome</td>
                                  <td>$cpf</td>
                                  <td>$telefone</td>
                                  <td>$email</td>
                                  <td><a href='funcionarioAtualizar.php?id=$cod_funcionario'><i class='far fa-edit fa-2x'></i></a></td>
                                  <td><a href='../../controle/excluir_funcionario_script.php?id=$cod_funcionario'><i  class='far fa-trash-alt fa-2x' style='color: red;'></i></a></td>
                                </tr>";    
                            }
                          ?>
                        </tbody>
