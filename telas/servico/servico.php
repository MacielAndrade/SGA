                    ...
                    <div class="col-sm-12" > 
                      <div class="row " >
                        <main class="form-signin">
                          <form action="../../controle/cadastro_servico_script.php" method="POST">
                            <div class="form-group">
                                <label>Serviço</label>
                                <input type="text" name="servico" id="servico" class="form-control" placeholder="Serviço" required> 
                            </div>

                            <div class="form-group">
                                <label>Descrição do Serviço</label>
                                <textarea type="text" name="descricao" class="form-control" id="descricao" placeholder="Descrição do Serviço"></textarea>
                            </div>

                            <div class="form-group">
                                <label for="floatingInput">Valor do Serviço</label>
                                <input type="text" class="form-control"  name="valorServico" id="valorServico" placeholder="Valor do Serviço">
                            </div>
