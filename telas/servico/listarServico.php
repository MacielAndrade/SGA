        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class="container-fluid">
                    <div class="collapse navbar-collapse justify-content-right" id="navigation">
                        <button>
                            <a href="servico.php" style="color: black;"><i class="fas fa-chevron-left fa-2x"></i></a>
                        </button>
                    </div>
                    <a class="navbar-brand" href=""> PESQUISAR SERVIÇOS </a>
                    <div class="collapse navbar-collapse justify-content-end" id="navigation">
                        <form method="POST">
                            <ul class="navbar-nav ml-auto">

                                <div class="col-sm-10">
                                    <input class="form-control me-2" type="search" name="buscar" placeholder="Digite o nome do Serviço" aria-label="Search">
                                </div>
                                <div class="col-sm-3">
                                    <li class="nav-item">
                                        <button  type="submit" >
                ...
                <div class="container">
                  ...
                  <div class="row" >
                    <?php
                      ...
                      $sql="SELECT * FROM catalogo_servicos WHERE nome_servico LIKE '%$pesquisa%'";
                      ...
                      <table class="table">
                        <thead class="thead-dark">
                          <tr>
                            ...
                            <th colspan="4">DESCRIÇÃO DOS SERVIÇOS</th>
                          </tr>
                        </thead>
                        <tbody>
                         <?php
                            while ($linha = mysqli_fetch_assoc($dados)){
                                $cod_servico = $linha['cod_servico'];
                                $servico = $linha['nome_servico'];
                                $valorServico = $linha['valor_servico'];
                                $descricao = $linha['descricao_servico'];
                                echo "<tr>
                                  <td>$servico</td>
                                  <td>$valorServico</td>
                                  <td>$descricao</td>
                                  <td><a href='servicoAtualizar.php?id=$cod_servico'><i class='far fa-edit fa-2x'></i></a></td>
                                  <td><a href='../../controle/excluir_servico_script.php?id=$cod_servico'><i  class='far fa-trash-alt fa-2x' style='color: red;'></i></a></td>
                                </tr>";    
                            }
                          ?>
                        </tbody>
